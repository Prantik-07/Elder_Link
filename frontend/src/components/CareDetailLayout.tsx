...
export function CareDetailLayout({ children }: { children: ReactNode }) {
  ...
  return (
    <div className="mx-auto flex max-w-6xl">
      <div className="min-w-0 flex-1 px-4 py-6 sm:px-6 lg:py-8">{children}</div>

      <aside
        className="sticky top-16 hidden h-[calc(100vh-4rem)] w-[26rem] shrink-0 border-l lg:block"
